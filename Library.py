class LibraryManagementSystem:
    def __init__(self):
        ...
        self.student_users = {'Eman': '456'}  # Sample student credentials
        self.books = [
            {'title': 'To Kill a Mockingbird', 'author': 'Harper Lee', 'subject': 'Heroism', 'status': 'available'},
            {'title': 'The Kite Runner', 'author': 'Khaled Hosseini', 'subject': 'Price of Betrayal', 'status': 'available'},
            {'title': 'Harry Potter', 'author': 'J.K. Rowling', 'subject': 'Dark Arts', 'status': 'available'},
            {'title': 'The Lord of the Rings', 'author': 'J.R.R. Tolkien', 'subject': 'Death and Immortality', 'status': 'available'},
            {'title': 'The Lost Symbol', 'author': 'Dan Brown', 'subject': 'Thriller', 'status': 'available'},
            {'title': 'Great Expectations', 'author': 'Charles Dickens', 'subject': 'Social Mobility', 'status': 'available'},
            {'title': 'Forty Rules of Love', 'author': 'Elif Shafak', 'subject': 'Sufism', 'status': 'available'},
            {'title': 'The Architects Apprentice', 'author': 'Elif Shafak', 'subject': 'Artistic Freedom', 'status': 'available'},
            {'title': 'Think and Grow Rich', 'author': 'Napoleon Hill', 'subject': 'Self-help', 'status': 'available'},
            {'title': 'The Silent Patient', 'author': 'Alex Michaelides', 'subject': 'Psychological Thriller', 'status': 'available'}
        ]
